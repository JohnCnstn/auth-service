...
public class OpenapiControllerTest extends AbstractIntegrationTest {
    ...
    public void openapiUiRedirect_happyPath() throws Exception {
        // GIVEN
        // WHEN
        var resultActions = mockMvc.perform(get(OPENAPI_UI_REDIRECT_PATH));
        // THEN
    ...
    public void fetchUiConfiguration_happyPath() throws Exception {
        // GIVEN
        // WHEN
        var resultActions = mockMvc.perform(get(GET_UI_CONFIGURATION_PATH));
        var body = resultActions.andReturn().getResponse().getContentAsString();
        // THEN
    ...
    public void fetchSecurityConfiguration_happyPath() throws Exception {
        // GIVEN
        // WHEN
        var resultActions = mockMvc.perform(get(GET_SECURITY_CONFIGURATION_PATH));
        var body = resultActions.andReturn().getResponse().getContentAsString();
        // THEN
        resultActions.andExpect(status().isOk());
        assertNotNull(body);
    ...
    public void fetchConfiguration_happyPath() throws Exception {
        // GIVEN
        // WHEN
        var resultActions = mockMvc.perform(get(GET_CONFIGURATION_PATH));
        var body = resultActions.andReturn().getResponse().getContentAsString();
        // THEN
        resultActions.andExpect(status().isOk());
        assertNotNull(body);
    ...
    public void fetchOpenapiYaml_happyPath() throws Exception {
        // GIVEN
        // WHEN
        var resultActionsYml = mockMvc.perform(get(GET_OPENAPI_YML_PATH));
        var resultActionsYaml = mockMvc.perform(get(GET_OPENAPI_YAML_PATH));

        var bodyYml = resultActionsYml.andReturn().getResponse().getContentAsString();
        var bodyYaml = resultActionsYaml.andReturn().getResponse().getContentAsString();
        // THEN
    ...
    public void fetchOpenapiJson_happyPath() throws Exception {
        // GIVEN
        // WHEN
        var resultActions = mockMvc.perform(get(GET_OPENAPI_JSON_PATH));
        var body = resultActions.andReturn().getResponse().getContentAsString();
        // THEN
        resultActions.andExpect(status().isOk());
        assertNotNull(body);
