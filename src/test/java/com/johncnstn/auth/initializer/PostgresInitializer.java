package com.johncnstn.auth.initializer;
...
public class PostgresInitializer
    ...
    private static final String POSTGRES_USER = "auth";
    private static final String POSTGRES_PASSWORD = "auth";
    private static final String POSTGRES_DB = "auth-backend";
